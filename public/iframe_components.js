...
(function () {
  ...
  if (typeof React === "undefined") {
    console.error(
      "iframe_components.js: React is not loaded. Make sure to load React before this script."
    );
    return;
  }
  ...
  function DetailPage({ data }) {
    ...
    const ImageNotFound = () =>
      /*#__PURE__*/ React.createElement(
        ...
        {
          className:
            "w-[210px] h-[320px] m-auto [border-radius:0_6%_6%_0_/4%] drop-shadow-md bg-gray-200 flex items-center justify-center border-2 border-dashed border-gray-400",
        },
        /*#__PURE__*/ React.createElement(
          "div",
          {
    ...
    const DetailLabel = ({ label, value }) => {
      ...
      return /*#__PURE__*/ React.createElement(
        ...
        {
          className:
            "flex text-[14px] leading-[18px] font-body mt-2 text-[#707070]",
        },
        /*#__PURE__*/ React.createElement(
          "p",
          {
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      {
        className:
          "mx-auto grid grid-cols-12 gap-6 mb-10 max-w-[1260px] min-w-[320px] w-full items-start mt-10",
      },
      /*#__PURE__*/ React.createElement(
        "div",
        {
        ...
        imageUrl && !imageError
          ? /*#__PURE__*/ React.createElement("img", {
              ...
              alt: title,
              className:
                "w-[210px] h-[320px] m-auto [border-radius:0_6%_6%_0_/4%] drop-shadow-md object-cover",
              onError: () => setImageError(true),
            })
          : /*#__PURE__*/ React.createElement(ImageNotFound, null)
      ),
      /*#__PURE__*/ React.createElement(
        "div",
        {
        ...
        /*#__PURE__*/ React.createElement(
          ...
          {
            className:
              "font-body grid grid-cols-9 gap-6 mt-3 max-h-[200px] overflow-y-auto",
          },
          /*#__PURE__*/ React.createElement(
            "div",
            {
        ...
        detail_section_header &&
          ...
          /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              {
                className:
                  "font-fancy text-[14px] leading-[20px] font-bold mt-6",
              },
              detail_section_header
            ),
            /*#__PURE__*/ React.createElement(
              ...
              details.map((detail, index) =>
                /*#__PURE__*/ React.createElement(DetailLabel, {
                  key: index,
                  label: detail.label,
                  value: detail.value,
                })
  ...
  function HorizontalCardList({
    ...
    const title =
      directTitle ?? (data === null || data === void 0 ? void 0 : data.title);
    const items =
      directItems ??
    ...
    const onItemClick =
      directOnItemClick ??
      (data === null || data === void 0 ? void 0 : data.onItemClick);
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      title &&
        /*#__PURE__*/ React.createElement(
          ...
          {
            className:
              "text-[14px] leading-[20px] font-semibold font-bold mt-6",
          },
          title
        ),
      /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              item.imageUrl &&
                ...
                /*#__PURE__*/ React.createElement("img", {
                  ...
                  className:
                    "w-[150px] h-[230px] m-auto [border-radius:0_6%_6%_0_/4%] drop-shadow-md group-hover:scale-105 transition-all duration-300 object-cover",
              ...
              /*#__PURE__*/ React.createElement(
                ...
                {
                  className:
                    "text-[#707070] text-[14px] leading-[18px] mt-2 w-[150px] max-w-[150px]",
                },
                item.firstLineText &&
                  /*#__PURE__*/ React.createElement(
                    "div",
    ...
    return /*#__PURE__*/ React.createElement(
      ...
      title &&
        /*#__PURE__*/ React.createElement(
          ...
          {
            className:
              "font-fancy text-[14px] leading-[20px] font-[600] font-bold mt-6",
          },
          title
        ),
      /*#__PURE__*/ React.createElement(
          ...
          /*#__PURE__*/ React.createElement(
            ...
            item.imageUrl &&
              ...
              /*#__PURE__*/ React.createElement("img", {
                ...
                alt: item.firstLineText || "",
                className:
                  "w-[80px] h-[125px] flex-shrink-0 [border-radius:0_6%_6%_0_/4%] drop-shadow-md group-hover:scale-105 transition-all duration-300",
                onError: () => markImageError(item.id),
              }),
            hasImageError(item.id) &&
              /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              ...
              item.secondLineText &&
                /*#__PURE__*/ React.createElement(
                  ...
                  {
                    className:
                      "text-[#707070] text-[12px] leading-[16px] font-body mt-1",
                  },
                  item.secondLineText
                ),
              item.thirdLineText &&
